...
print("Starting email shortening process...")

with open("url_emails.jsonl", "r", encoding="utf-8") as f_in, \
     open("shortened_url_emails.jsonl", "w", encoding="utf-8") as f_out: # 'w' mode to overwrite/start fresh
    ...
    for i, line in enumerate(lines, 1):
        ...
        print(f"[{i}/{len(lines)}] Shortening email ID {original_id}...")
        
        try:
            result = generator.generate("shorten", email_data)
